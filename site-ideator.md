...
Always double check text/background contrast ratios and make sure they are at least AA WCAG 2.1 accessible.

Use Google fonts, but do not use system fonts like Inter, Roboto, Arial, Helvetica. And do not use emojis under any circumstances.
